...
wget --no-check-certificate -O OpenClash+Kernel_a53.run https://cdn.jsdelivr.net/gh/qy2009/iptv@master/OpenClash_0.46.014+aarch_64_core.run
...
sh OpenClash_0.46.014+aarch_64_core.run
